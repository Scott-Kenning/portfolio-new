    ...
    >
      <div className="grid lg:grid-cols-3 max-w-5xl mx-auto md:pt-[10vh] justify-items-end">
        <div className="flex flex-col col-span-2 max-w-5xl gap-y-2">
          <p className="text-2xl md:text-4xl font-bold">Hi, I&apos;m Scott Kenning</p>
          <h1
            className="text-3xl md:text-6xl font-bold pb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-500"
          >
